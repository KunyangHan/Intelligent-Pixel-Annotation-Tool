...
export default class SLIC extends BaseSegmentation {
  ...
  _compute() {
    this.result = this.computeSLICSegmentation(this.imageData,
                                          this.regionSize,
                                          this.minRegionSize,
                                          this.maxIterations);
  };
  ...
  computeSLICSegmentation(imageData,
                                   regionSize,
                                   minRegionSize,
                                   maxIterations) {
    var i,
    ...
    this.initializeKmeansCenters(labData,
                            edgeMap,
                            currentCenters,
                            clusterParams,
                            numRegionsX,
    ...
    for (var iter = 0; iter < maxIterations; ++iter) {
      // Do assignment.
      this.assignSuperpixelLabel(labData,
                            segmentation,
                            mcMap,
                            msMap,
                            distanceMap,
    ...
    this.eliminateSmallRegions(segmentation,
                          minRegionSize,
                          numPixels,
                          imWidth,
                          imHeight);
