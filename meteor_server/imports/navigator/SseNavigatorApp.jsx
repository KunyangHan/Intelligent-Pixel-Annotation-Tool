...
class SseNavigatorApp extends React.Component {
    constructor() {
        ...
        this.increment = 20;
        this.state = {pageLength: this.increment, selection: new Set(), target: "0"};
    ...
    componentDidMount() {
        ...
        // targetPage.val("12344");
        // console.log(targetPage, typeof(targetPage));
        // targetPage.change(() => {
        //     console.log("changed", targetPage.val());
        //     $("#pageJumper").attr("href", $(this).val());
        // })
    }
    ...
    pageChange() {
        ...
        this.setState({target: targetPage.val()});
    }
            ...
            <MuiThemeProvider theme={new SseTheme().theme}>
                <div className="w100">
                    ...
                    <div className="sse-pager hflex">
                        ...
                        <input type="text" id="targetPage" onChange={this.pageChange}/>
                        <Link to={"/browse/" + this.state.target + "/20/"} id="pageJumper">
                            <IconButton touch="true"
                                        classes={{"colorPrimary": "white"}}>
                                <ArrowRightBold/>
                            </IconButton>
